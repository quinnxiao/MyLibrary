...
public final class MMAlert {
    ...
    public static AlertDialog showAlert(final Context context, final View view) {
        if (context instanceof Activity && ((Activity) context).isFinishing()) {
            return null;
        }
...
//    public static ProgressDialog showProgressDlg(final Context context,String meassge) {
//        ProgressDialog progressDialog = new LoadingDialog(context,R.style.CustomDialog);
//        progressDialog.setMessage(meassge);
//        progressDialog.show();
